  ...
  return (
    <div className="mt-4 border-t-2 border-accent bg-surface-raised shadow-lg rounded-b-lg p-5 animate-slide-up transition-all duration-300">
      <div className="flex flex-col gap-4">
        ...
        {/* Audit Details */}
        {compliance_details && (
          <div className="text-xs text-text-secondary bg-surface/50 border border-border p-3 rounded-md leading-relaxed font-medium">
            <div className="text-[10px] font-bold text-text-tertiary uppercase tracking-wider mb-1">Compliance Audit Logs:</div>
            {compliance_details}
          </div>
        )}
